...
| `Correlate.AspNet.WebApi` | [![NuGet](https://img.shields.io/nuget/v/Correlate.AspNet.WebApi.svg)](https://www.nuget.org/packages/Correlate.AspNet.WebApi/) [![NuGet](https://img.shields.io/nuget/dt/Correlate.AspNet.WebApi.svg)](https://www.nuget.org/packages/Correlate.AspNet.WebApi/) | Classic ASP.NET (IIS) integration. |
...
| [Classic ASP.NET](https://github.com/skwasjer/Correlate/tree/main/src/Correlate.AspNet.WebApi) | IIS HTTP module | [Correlate.AspNet.WebApi](https://www.nuget.org/packages/Correlate.AspNet.WebApi) | Classic ASP.NET (IIS) integration. |
