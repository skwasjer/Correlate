...
public static class FakeLogContextExtensions
{
    ...
    private static FakeLogContext CreateLoggerContext(this ILogger logger)
    {
    ...
    private static IReadOnlyList<FakeLogRecord> GetSnapshot(this FakeLogCollector collector, string id, bool clear = false)
    {
